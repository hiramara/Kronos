...
Notes (personal):
    ...
    - PRED_LEN set to 60 (approx. 3 months of trading days) for more practical near-term forecasts.
    - Retry sleep bumped to 2.0s to be gentler on the akshare API.
"""
...
PRED_LEN = 60    # reduced from 120; ~3 months of trading days is more actionable
T = 1.0
TOP_P = 0.9
SAMPLE_COUNT = 1
...
def load_data(symbol: str) -> pd.DataFrame:
    ...
    for attempt in range(1, max_retries + 1):
        ...
        time.sleep(2.0)  # bumped from 1.5s to be gentler on the API
